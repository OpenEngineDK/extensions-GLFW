...
#ifndef _OE_G_L_F_W_FRAME_H_
#define _OE_G_L_F_W_FRAME_H_
...
namespace Display {
    using std::string;
/**
 * GLFW implementation of IFrame
 *
 * @class GLFWFrame GLFWFrame.h Display/GLFWFrame.h
 */
class GLFWFrame : public IFrame {
private:
...
protected:
    ...
    friend class GLFWEnvironment;
public:
    GLFWFrame(int w = 640, int h = 480, int d = 32, FrameOption options = FrameOption());
    ~GLFWFrame();
